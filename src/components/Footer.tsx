...
const Footer: React.FC = () => {
  return (
    <footer className="w-full py-12 px-8 bg-secondary/50">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-4">
          <h3 className="text-lg font-medium">Virtual Try-On</h3>
          <p className="text-muted-foreground text-sm max-w-xs">
            Experience the future of clothing shopping with our state-of-the-art virtual try-on technology.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <h4 className="text-sm font-medium uppercase tracking-wider text-muted-foreground">Resources</h4>
          <ul className="space-y-2">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            <li><a href="#" className="text-sm hover:text-primary transition-colors">Privacy</a></li>
            <li><a href="#" className="text-sm hover:text-primary transition-colors">Terms</a></li>
            <li><a href="#" className="text-sm hover:text-primary transition-colors">Cookies</a></li>
          </ul>
        </div>
      </div>
